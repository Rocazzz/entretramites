...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Constitución de empresa en España",
      "Alta como autónomo o SL",
      "Asesoría fiscal primer año",
    ...
    <section id="precios" className="pricing">
      <div className="pricing__inner">
        ...
        <div className="pricing__header">
          <p className="section-eyebrow">Tarifas</p>
          <h2 className="section-title">Nuestros servicios</h2>
          <p className="pricing__note">
            Precios orientativos. Tu gestor confirmará el precio exacto en la consulta.
          </p>
        </div>
